...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMarketingCardTemplateCreateModel : AopObject
    {
        ...
        /// 卡级别配置
        /// </summary>
        [XmlArray("card_levle_conf")]
        [XmlArrayItem("template_card_level_conf_d_t_o")]
        public List<TemplateCardLevelConfDTO> CardLevleConf { get; set; }
        ...
        /// <summary>
        /// 卡包详情页面中展现出的卡码（可用于扫码核销）  qrcode: 二维码  dqrcode: 动态二维码  barcode: 条码  dbarcode: 动态条码  text: 文本  url: 连接
        /// </summary>
